...
export default function VerifierLogin() {
  ...
  const from = (location.state as { from?: { pathname: string } })?.from?.pathname || '/dashboard/verifier';
      ...
      <div className="w-full max-w-4xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center animate-fade-in">
          ...
          <p className="mt-2 text-muted-foreground text-center max-w-xs">
            Instantly verify academic credentials with blockchain-backed security
          </p>
        </div>
